    ...
    return ClipRRect(
      ...
      child: GridTile(
        child: GestureDetector(
          onTap: () {
            //forward only id to productdetailscreen route
        ...
        footer: GridTileBar(
          ...
          //wrapping in Consumer<Product> adds listener that only rebuilds this button
          //when isFavorite has been altered, not entire product item
